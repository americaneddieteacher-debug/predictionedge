...
프로덕션 DB에는 마이그레이션 054~063이 이미 적용·검증됐어. 해야 할 일:
1. ibookk-fixes의 마이그레이션(054~063)을 이 저장소 마이그레이션 폴더에 복사해 동기화
...
DB 보안(진단 108→0 수준)·성능·실버그 6건 수정·E2E 14+건 검증·마이그레이션 054~063·
